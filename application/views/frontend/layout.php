...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo public_url() ?>/../upload/img/favicon.png" type="image/x-icon" />
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-6">
                        <div class="logo main">
                            <a href="index.html"><img class="responsive" src="<?php echo public_url() ?>/../upload/img/logo.png" alt="Startkit"></a>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="header-slider">
                    <div class="header-single-slider">
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/sliders/slider01.jpg" alt="">
                            <figcaption>
                                <div class="content">
                    ...
                    <div class="header-single-slider">
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/sliders/slider02.jpg" alt="">
                            <figcaption>
                                <div class="content">
                    ...
                    <div class="header-single-slider">
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/sliders/slider03.jpg" alt="">
                            <figcaption>
                                <div class="content">
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-4 col-sm-6 single-contact">
                        <img src="<?php echo public_url() ?>/../upload/img/icons/icon01.png" alt="">
                        <p><b>10/45 Beer Street Heaven,</b><br>California Floor, USA 1208</p>
                    </div>
                    <div class="col-md-4 col-sm-6 single-contact">
                        <img class="pt-2" src="<?php echo public_url() ?>/../upload/img/icons/icon02.png" alt="">
                        <p><b>+001-2156-2459</b><br>example@mail.com</p>
                    </div>
                    <div class="col-md-4 col-sm-6 single-contact">
                        <img src="<?php echo public_url() ?>/../upload/img/icons/icon03.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 mb-lg-0">
                    <div class="service-box">                        
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/service/service01.jpg" alt="">
                            <figcaption>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-sm-4 mb-md-0">
                    <div class="service-box">                        
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/service/service02.jpg" alt="">
                            <figcaption>
                                <div class="inner-text">
                                    <div class="service-icon">
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3 col-sm-12">
                    <div class="service-box">                        
                        <figure>
                            <img src="<?php echo public_url() ?>/../upload/img/service/service03.jpg" alt="">
                            <figcaption>
                                <div class="inner-text">
                                    <div class="service-icon">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon01.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 features-box pb-3">
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon02.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 features-box pb-3">
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon03.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
                            <h3>Performance</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 features-box pt-3 pb-3">
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon04.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
                            <h3>Organization</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 features-box pt-3 pb-3">
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon05.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 features-box pt-3 pb-3">
                    <div class="row">
                        <div class="col-3">
                            <div class="features-box-icon">
                                <img src="<?php echo public_url() ?>/../upload/img/features-icon/features-icon06.png" alt="">
                            </div>
                        </div>
                        <div class="col-9">                                
        ...
        <div class="container">
            ...
            <div class="row project" id="grid">
                <div class="col-lg-3 col-md-6 col-sm-12" data-groups='["Branding", "Web", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project03.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Business Style</h4>
                                <p>Randomised words which don look even slightly believable. If going to use a passage of Lorem</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project03.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12" data-groups='["Branding","Creative", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project04.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Business Style</h4>
                                <p>Randomised words which don look even slightly believable. If going to use a passage of Lorem</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project04.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-lg-6 col-md-12" data-groups='["Creative", "More", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project01.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Corporate Business</h4>
                                <p>There are many variations of passages of that Lorem Ipsum available but the majority.</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project01.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-lg-6 col-md-12" data-groups='["Branding", "Creative", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project02.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Business Style</h4>
                                <p>Randomised words which don look even slightly believable. If going to use a passage of Lorem</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project02.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-lg-9 col-md-12" data-groups='["Branding","Creative", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project06.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Business Style</h4>
                                <p>Randomised words which don look even slightly believable. If going to use a passage of Lorem</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project06.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12" data-groups='["Branding", "Web", "Show All"]'>
                    <figure>
                        <img src="<?php echo public_url() ?>/../upload/img/project/project05.jpg" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <h4>Business Style</h4>
                                <p>Randomised words which don look even slightly believable. If going to use a passage of Lorem</p>
                                <a href="<?php echo public_url() ?>/../upload/img/project/project05.jpg" class="boxed-btn">View more</a>
                            </div>
                        </figcaption>
                    </figure>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                    <div class="projects-mockup">
                        <img src="<?php echo public_url() ?>/../upload/img/mockup.png" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div id="gallery-items" class="gallery-items popup-gallery">
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary1.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary1.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary2.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary2.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary3.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary3.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary4.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary4.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary5.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary5.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary6.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary6.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary7.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary7.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary8.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary8.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary9.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary9.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                    <div class="single-item">
                        <a href="<?php echo public_url() ?>/../upload/img/gallery/gallary10.jpg">
                            <img src="<?php echo public_url() ?>/../upload/img/gallery/gallary10.jpg" alt="" />
                            <div><i class="fas fa-expand"></i></div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="testimonial-carousel">
                        <div class="single-testimonial">
                            <div class="icon">
                                <img src="<?php echo public_url() ?>/../upload/img/quote.png" alt="">
                            </div>
                            ...
                            <hr>
                            <div class="info">
                                <img src="<?php echo public_url() ?>/../upload/img/tesimonial/speaker01.png" alt="">
                                <h3>Ben Horowitz</h3>
                        ...
                        <div class="single-testimonial">
                            ...
                            <hr>
                            <div class="info">
                                <img src="<?php echo public_url() ?>/../upload/img/tesimonial/speaker02.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-member" style="background-image: url(<?php echo public_url() ?>/../upload/img/team/team01.jpg);">
                        <div class="overlay">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-member" style="background-image: url(<?php echo public_url() ?>/../upload/img/team/team02.jpg);">
                        <div class="overlay">
                            <div class="overlay-wrapper">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-sm-4">
                    <div class="team-member" style="background-image: url(<?php echo public_url() ?>/../upload/img/team/team03.jpg);">
                        <div class="overlay">
                            <div class="overlay-wrapper">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-member" style="background-image: url(<?php echo public_url() ?>/../upload/img/team/team04.jpg);">
                        <div class="overlay">
                            <div class="overlay-wrapper">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 mb-lg-0">
                    <article class="blog-post">
                        <div class="post-thumbnail">
                            <img src="<?php echo public_url() ?>/../upload/img/latest-news/latest-news-01.jpg" alt="" class="img-responsive center-block">
                            <div class="post-overlay"><img src="<?php echo public_url() ?>/../upload/img/author01.png" alt=""></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 mb-lg-0">
                    <article class="blog-post">
                        <div class="post-thumbnail">
                            <img src="<?php echo public_url() ?>/../upload/img/latest-news/latest-news-02.jpg" alt="" class="img-responsive center-block">
                            <div class="post-overlay"><img src="<?php echo public_url() ?>/../upload/img/author01.png" alt=""></div>
                            <ul class="meta-info list-inline">
                                <li class="posted-by"><a href="#"><i class="fas fa-user"></i>Lily Simith</a></li>
                                <li class="tags"><a href="#"><i class="fas fa-newspaper"></i>Uncategorized</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 offset-md-3 offset-lg-0">
                    <article class="blog-post">
                        <div class="post-thumbnail">
                            <img src="<?php echo public_url() ?>/../upload/img/latest-news/latest-news-03.jpg" alt="" class="img-responsive center-block">
                            <div class="post-overlay"><img src="<?php echo public_url() ?>/../upload/img/author01.png" alt=""></div>
                            <ul class="meta-info list-inline">
                                <li class="posted-by"><a href="#"><i class="fas fa-user"></i>Lily Simith</a></li>
                                <li class="tags"><a href="#"><i class="fas fa-newspaper"></i>Uncategorized</a></li>
                    ...
                    <div class="partner-carousel">
                        <div class="single-partner">
                            <div class="inner-partner">
                                <img src="<?php echo public_url() ?>/../upload/img/partner/partner01.png" alt="">
                            </div>
                        </div>
                        <div class="single-partner">
                            <div class="inner-partner">
                                <img src="<?php echo public_url() ?>/../upload/img/partner/partner02.png" alt="">
                            </div>
                        </div>
                        <div class="single-partner">
                            <div class="inner-partner">
                                <img src="<?php echo public_url() ?>/../upload/img/partner/partner03.png" alt="">
                            </div>
                        </div>
                        <div class="single-partner">
                            <div class="inner-partner">
                                <img src="<?php echo public_url() ?>/../upload/img/partner/partner04.png" alt="">
                            </div>
                        </div>
                        <div class="single-partner">
                            <div class="inner-partner">
                                <img src="<?php echo public_url() ?>/../upload/img/partner/partner05.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 mb-lg-0 mb-4">
                    <aside class="widget widget_about">
                        <div class="footer-logo"><img src="<?php echo public_url() ?>/../upload/img/logo.png" alt=""></div>
                    ...
                    <aside class="widget widget_recent">
                        ...
                        <ul>
                            <li class="latest-news">
                                <a href="#">
                                    <img src="<?php echo public_url() ?>/../upload/img/news-widget/news-widget-01.jpg" alt="">
                            ...
                            <li class="latest-news">
                                <a href="#">
                                    <img src="<?php echo public_url() ?>/../upload/img/news-widget/news-widget-02.jpg" alt="">
                            ...
                            <li class="latest-news">
                                <a href="#">
                                    <img src="<?php echo public_url() ?>/../upload/img/news-widget/news-widget-03.jpg" alt="">
    ...
    <script src="<?php echo public_url() ?>/js/jquery.sticky.js"></script>
    <script src="<?php echo public_url() ?>/js/owl.carousel.min.js"></script>
    <script src="<?php echo public_url() ?>/js/jquery.shuffle.min.js"></script>
    <script src="<?php echo public_url() ?>/js/jquery.counterup.min.js"></script>
    <script src="<?php echo public_url() ?>/js/wow.min.js"></script>
    <script src="<?php echo public_url() ?>/js/jquery.meanmenu.min.js"></script>
    <script src="<?php echo public_url() ?>/js/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo public_url() ?>/js/jquery.hoverdir.js"></script>
